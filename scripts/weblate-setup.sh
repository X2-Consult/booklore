...
#   2. Ensure your GitHub repo (X2-Consult/booklore) is public (required for Libre plan)
#
# Usage:
...
PROJECT_WEB="https://github.com/X2-Consult/booklore"

REPO_URL="https://github.com/X2-Consult/booklore.git"
REPO_BRANCH="develop"
